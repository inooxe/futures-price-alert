...
# دریافت اطلاعات از متغیرهای محیطی (برای امنیت بیشتر در گیت‌هاب)
telegram_token = os.getenv("TELEGRAM_TOKEN")
chat_id = os.getenv("CHAT_ID")

# بررسی اینکه مقادیر به درستی بارگذاری شده‌اند
if not telegram_token or not chat_id:
    raise ValueError("TELEGRAM_TOKEN یا CHAT_ID تعریف نشده است.")
